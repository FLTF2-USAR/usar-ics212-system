import{c as g}from"./createLucideIcon-Dr5vU0D_.js";import{r as D,j as w,_ as S}from"./index-C5-3beP-.js";import{c as T,l as h,L as f,D as $,A as E}from"./useApparatusStatus-DdeTg28Y.js";const x=[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]],C=g("calendar",x);const A=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],j=g("check",A);const P=[["path",{d:"M12 3v12",key:"1x0j5s"}],["path",{d:"m17 8-5-5-5 5",key:"7q97r8"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}]],R=g("upload",P);const F=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],v=g("x",F),N=({isOpen:y,onClose:e,title:t,children:s,className:o})=>(D.useEffect(()=>(y?document.body.style.overflow="hidden":document.body.style.overflow="unset",()=>{document.body.style.overflow="unset"}),[y]),y?w.jsxs("div",{className:"fixed inset-0 z-50 flex items-center justify-center",children:[w.jsx("div",{className:"absolute inset-0 bg-black/50 backdrop-blur-sm",onClick:e}),w.jsxs("div",{className:T("relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto",o),children:[w.jsxs("div",{className:"flex items-center justify-between px-6 py-4 border-b border-gray-200",children:[w.jsx("h2",{className:"text-xl font-semibold text-gray-900",children:t}),w.jsx("button",{onClick:e,className:"p-1 hover:bg-gray-100 rounded-lg transition-colors",children:w.jsx(v,{className:"w-5 h-5 text-gray-500"})})]}),w.jsx("div",{className:"px-6 py-4",children:s})]})]}):null);class I{adminPassword=null;constructor(){}setAdminPassword(e){this.adminPassword=e}clearAdminPassword(){this.adminPassword=null}isAdminAuthenticated(){return this.adminPassword!==null}getHeaders(e=!1){const t={"Content-Type":"application/json"};return e&&this.adminPassword&&(t["X-Admin-Password"]=this.adminPassword),t}async checkExistingDefects(e){try{const t=await fetch(`${h}/issues?state=open&labels=${f.DEFECT},${encodeURIComponent(e)}&per_page=100`,{method:"GET",headers:this.getHeaders()});if(!t.ok)return console.warn(`Failed to fetch defects: ${t.statusText}`),new Map;const s=await t.json(),o=Array.isArray(s)?s:[],c=new Map;for(const l of o){const r=l.title.match($);if(r){const[,,n,a]=r,i=`${n}:${a}`;c.set(i,l)}}return c}catch(t){return console.error("Error fetching existing defects:",t),new Map}}async submitChecklist(e){const{user:t,apparatus:s,date:o,defects:c}=e,l=await this.checkExistingDefects(s);let r=0;const n=[];for(const a of c)try{const i=`${a.compartment}:${a.item}`,d=l.get(i);d?await this.addCommentToDefect(d.number,t.name,t.rank,o,a.notes,a.photoUrl):await this.createDefectIssue(s,a.compartment,a.item,a.status,a.notes,t.name,t.rank,o,a.photoUrl)}catch(i){r++;const d=`${a.compartment}:${a.item}`;n.push(d),console.error(`Failed to process defect ${d}:`,i)}if(r>0)throw new Error(`Failed to submit ${r} defect(s): ${n.join(", ")}. Please try again.`);if(await this.createLogEntry(e),c.length>0)try{await this.createSupplyTasksForDefects(c,s)}catch(a){console.error("Failed to create supply tasks (non-fatal):",a)}}async createDefectIssue(e,t,s,o,c,l,r,n,a){const i=`[${e}] ${t}: ${s} - ${o==="missing"?"Missing":"Damaged"}`;let d=`
## Defect Report
